...
namespace Armr.Azure
{
    ...
    public interface ITemplateBuilder : IBuilder<AzureResourceTemplate>
    {
    ...
    public interface IParametersBuilder : IBuilder<Dictionary<string, Parameter>>
    {
        ...
        IParametersBuilder String(string name, string defaultValue = null, int? minLength = null, int? maxLength = null, string metadata = null, params string[] allowedValues);
    ...
    public class ParametersBuilder : IParametersBuilder
    {
        ...
        {
            parameters.Add(name, new SecureStringParameter { DefaultValue = defaultValue, MinLength = minLength, MaxLength = maxLength });
            return this;
        }

        public IParametersBuilder String(string name, string defaultValue = null, int? minLength = null, int? maxLength = null, string metadata = null, params string[] allowedValues)
        {
            parameters.Add(name, new StringParameter { DefaultValue = defaultValue, MinLength = minLength, MaxLength = maxLength, AllowedValues = allowedValues, Metadata = new Metadata { Description = metadata }  });
            return this;
        }
    ...
    {
        private AzureResourceTemplate template;
        public TemplateBuilder()
        {
            template = new AzureResourceTemplate();
        }
        ...
        public AzureResourceTemplate Build()
        {
